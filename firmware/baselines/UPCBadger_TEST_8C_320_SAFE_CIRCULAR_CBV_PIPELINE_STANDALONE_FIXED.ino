...
#define CBV_FILE "/ConsoleBadger_320_CIRCULAR_SAFE_DIRECTDMA.CBV"
...
void setup()
{
  ...
  Serial.println();
  Serial.println("==========================================");
  Serial.println(" UPCBadger TEST 8C");
  Serial.println(" 320 SAFE-CIRCULAR CBV + DMA PIPELINE");
  Serial.println("==========================================");

  Serial.println("TFT: 360x360 / 80 MHz");
  Serial.println("Artwork: 320x320 / circular feather");
  Serial.println("CBV: DIRECT-DMA RGB565");
